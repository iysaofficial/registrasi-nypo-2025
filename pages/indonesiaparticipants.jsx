...
export default function Internationalparticipants() {
  ...
  useEffect(() => {
    const scriptURL =
      "https://script.google.com/macros/s/AKfycbzu3DFBcVIfh6iLtMBsx5v2uENy_mAelFku_DTy-gVNpBl0Mbl4NokAd5OhrN5i6BWA6w/exec";
      ...
      <section className="registration-section">
        <div className="container">
          <div className="content">
            ...
            <br />
            <h4>
              HALLO PESERTA NYPO 2025, Mohon perhatikan informasi berikut ini
              ...
              <div className="user-details">
                ...
                <div className="input-box">
                  <label for="SUMBER_INFORMASI" className="form-label">
                    Sumber Informasi Kompetisi NYPO 2025
                  </label>
                  <select
                    type="text"
                    id="SUMBER_INFORMASI"
                  ...
                  >
                    ...
                    <option value="NYPO Instagram">NYPO Instagram</option>
